...
export default class DemoRanderPhim extends Component {
  arrPhim = [
    {
      maPhim: 1283,
      tenPhim: "Trainwreck",
  ...
  render() {
    return (
      <div>
        <h1>Demo Rander Phim</h1>
        <div className="row">
          {this.arrPhim.map((newPhim, index) => {
            return (
              <div key={index} className="col-3 text-center max-w-sm rounded overflow-hidden shadow-lg">
                <img
                  className="w-full"
                  src={newPhim.hinhAnh}
